...
import {_GetMyOpenTask,_GetAllClientOpenTask,_DeleteTaskInOpenTaskList} from './../../services/MyopenTaskServices/MyOpenTaskServices';
...
export default  class MyOpenTask extends React.Component {
  constructor(props) {
    super(props);
...
async GetAllOpenandClosetask(){
        ...
        let fulldata= await _GetMyOpenTask()
...
<View>
        ...
        _EditRow(id){
              ...
              //  alert(id)
            const {navigate} = this.props.navigation;
            navigate('ViewMyopenTaskScreen', {Opentask_id: id})
        }
