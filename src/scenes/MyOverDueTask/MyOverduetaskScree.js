...
import {_GetMy_OverDueTask,_GetAllClientOpenTask,_DeleteTaskInOpenTaskList} from './../../services/MyOverdueServices/MyOverDueServices';
...
export default  class MyOverduetaskScree extends React.Component {
  constructor(props) {
    super(props);
...
<View>
        ...
        _EditRow(id){
              ...
              //  alert(id)
            const {navigate} = this.props.navigation;
            navigate('ViewMyOverDuetaskScreen', {Opentask_id: id})
        }
