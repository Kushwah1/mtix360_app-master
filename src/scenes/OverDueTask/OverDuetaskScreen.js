...
import {_GetOpenTask,_GetAllClientOpenTask,_DeleteTaskInOpenTaskList} from '../../services/OverDueServices/OverDueServices';
...
export default  class OverDuetaskScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.ListSecondView}>
        ...
        _EditRow(id){
              ...
              //  alert(id)
            const {navigate} = this.props.navigation;
            navigate('ViewOverDueTaskscreen', {Opentask_id: id})
        }
